...
<body style="background-color:grey;">
	<h1 align="center">
	<span class="badge bg-secondary">Tabela Camere:</span>
	</h1>
	<br>
	<br />
	<p align="center">
		<button type="button" onclick="location.href='nou_Camera.jsp'" class="btn btn-dark"><div > Adauga o noua camera.</div> </button>
	</p>	
	<form action="stergere_Camera.jsp" method="post">
		...
		<br />
		<p align="center">
			<button type="submit" onclick="location.href='tabela_camere.jsp'"  class="btn btn-dark">Sterge liniile marcate</button>
